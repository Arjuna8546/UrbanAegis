...
class OfferListView(LoginRequiredMixin, StaffRequiredMixin, ListView):
    model = Offer
...
class OfferCreateView(LoginRequiredMixin, StaffRequiredMixin, CreateView):
    model = Offer
...
class OfferUpdateView(LoginRequiredMixin, StaffRequiredMixin, UpdateView):
    model = Offer
    form_class = OfferForm
    template_name = 'offer.html'
    success_url = reverse_lazy('offer_list')
...
class OfferDeleteView(LoginRequiredMixin, StaffRequiredMixin, DeleteView):
    model = Offer
    success_url = reverse_lazy('offer_list')
